...
export const goLessons = [
  ...
  new LessonItem(
    ...
    [
      ...
      new LessonRequest(
        "Расскажи о кратком определнии переменной в Go",
        "Краткое определение перменной"
      ),
    ]
  ),
  new LessonItem(
  ...
  new LessonItem(
    ...
    [
      ...
      new LessonRequest(
        "Расскажи о рекурсивых функциях в go",
        "Рекурсивые функции"
      ),
    ]
  ),
  ...
  new LessonItem(
    ...
    [
      ...
      new LessonRequest("Расскажи о алиморфизме  в Go?", "Полиморфизм"),
    ]
  ),
  new LessonItem(
    "Горутины",
